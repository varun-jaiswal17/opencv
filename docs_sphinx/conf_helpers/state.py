...
# Contrib modules for API reference (Extra Modules); env OPENCV_CONTRIB_API_MODULES
CONTRIB_API_MODULES = [
    m.strip()
    for m in (_os.environ.get("OPENCV_CONTRIB_API_MODULES") or "ml,alphamat").split(",")
    if m.strip()
]
...
__all__ = [
    ...
    "CONTRIB_MODULES", "CONTRIB_ROOT", "SPHINX_INPUT_ROOT", "API_MODULES", "CONTRIB_API_MODULES",
